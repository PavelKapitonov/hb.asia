...
function pay(amount) {
  var handler = StripeCheckout.configure({
    key: 'pk_test_51NZpDUC9ewgEdVcF8kIzb8752pcFn9sOZdm66OSqTAtxQ4749H1SUAvhJaX54S39K2VpyvZNSy2BSwC8PqOXPXsl003gOnvDUt', // your publisher key id
    locale: 'auto',
    token: function (token) {
      ...
      $.ajax({
        url:"<?php echo base_url(); ?>stripe/start",
        method: 'post',
...
<form action="/en/stripe/start" method="POST">
